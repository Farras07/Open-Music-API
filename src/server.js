...
const init = async () => {
  ...
  const storageService = new StorageService(path.resolve(__dirname, 'api/uploads/albums/covers'));
  ...
  server.auth.strategy('openmusic_jwt', 'jwt', {
    keys: config.token.access_token_key,
    verify: {
      aud: false,
      iss: false,
      sub: false,
      maxAgeSec: config.token.access_token_age,
    },
    validate: (artifacts) => ({
      isValid: true,
      credentials: {
